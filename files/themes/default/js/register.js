function bofRegister(formID, passwordDifficultyLevel, regTextStrings)
{
	...
	function checkUsername(is_auto)
	{
		...
		getXMLDocument(bof_prepareScriptUrl(bof_scripturl) + 'action=register;sa=usernamecheck;xml;username=' + checkName, checkUsernameCallback);
	...
	function setVerificationImage(imageHandle, imageIcon, alt)
	{
		...
		imageHandle.src = bof_images_url + '/icons/' + curImage;
		imageHandle.alt = alt;
