...
function bof_PersonalMessageSend(oOptions)
{
	this.opt = oOptions;
	this.oBccDiv = null;
	this.oBccDiv2 = null;
...
bof_PersonalMessageSend.prototype.init = function()
{
...
bof_PersonalMessageSend.prototype.showBcc = function()
{
...
bof_PersonalMessageSend.prototype.callbackAddItem = function(oAutoSuggestInstance, sSuggestId)
{
